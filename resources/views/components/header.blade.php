...
<header class="dark:bg-[#04000D] dark:text-white border-b shadow-xs">
    <div class="container mx-auto py-3.5 flex lg:flex-row justify-between items-center">
        {{-- Menu - Mobile --}} 
        <div x-data="{ open: false }" class="lg:hidden relative">
            <x-ui.button
                ...
                variant="link"
                size="icon">
                <x-icon name="three-lines-horizontal" class="w-7! h-7! text-black dark:text-white"/>
            </x-ui.button>
                            ...
                            @foreach ($sidebarItems as $sidebarItem)
                                ...
                                <li>
                                    <a 
                                        ...
                                        <p class="text-base lg:text-sm">{{ $sidebarItem['label'] }}</p>
                                    </a>
                                </li>
                            @endforeach
                            <li>
                                <a 
                                    ...
                                    <p class="text-base lg:text-sm">Keluar</p>
                                </a>
                            </li>
                        @endauth
                        ...
                        @guest
                            ...
                            <li>
                                <a 
                                    ...
                                    <p class="text-base lg:text-sm">History</p>
                                </a>
                            </li>
                            ...
                            <li>
                                <a 
                                    ...
                                    <p class="text-base lg:text-sm">Masuk</p>
                                </a>
                            </li>
                            ...
                            <li>
                                <a 
                                    ...
                                    <p class="text-base lg:text-sm">Daftar</p>
                                </a>
                            </li>
                        @endguest
                    </ul>
        ...
        {{-- Logo --}}
        <a href={{ route('index') }}>
            <x-icon name="logo" class="w-30 lg:w-35 text-black dark:text-white" />
        </a>
