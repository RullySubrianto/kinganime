                        ...
                        <div
                            ...
                            <form action="" method="POST" class="space-y-3">
                                ...
                                <div class="flex justify-between items-center">
                                    ...
                                    <button type="button" wire:click="resetFliters(['createdFrom', 'createdUntil'])" class="text-red-600 text-xs font-semibold hover:underline">Reset</button>
                                </div>
                    ...
                    <div class="pl-2 pr-3 relative" @click.outside="open = null" @keydown.escape.window="open = null">
                        ...
                        <div
                            ...
                            <div class="flex justify-between items-center">
                                ...
                                <button type="button" wire:click="resetColPref" class="text-red-600 text-xs font-semibold hover:underline">Reset</button>
                            </div>
                    ...
                    <tr 
                        ...
                        <td class="pr-4 py-3 whitespace-nowrap">
                            <div class="flex items-center gap-2">
                                ...
                                {{-- Delete Button --}}
                                <button class="ml-2 cursor-pointer" form="all-video.destroy">
                                ...
                                <form id="all-video.destroy" action="{{ route('all-video.destroy', $video->id) }}" method="POST" class="hidden">
                                    @csrf
                                    @method('DELETE')
                                </form>
                            </div>
